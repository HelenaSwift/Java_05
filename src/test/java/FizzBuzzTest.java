...
public class FizzBuzzTest {
    ...
    public void testStartLessThanEnd_HappyPath() {
        ...
        /* обязательно проверяем тест с измененным expectedResult, например ставим вместо1 число 2 */
        //вот что выдал тест с 2 вместо 1
        //java.lang.AssertionError: Arrays differ at element [0]: 2 != 1
        //Expected :2
        //Actual   :1
